...
// configuration methods on a [github.com/pritunl/mongo-go-driver/bson.Encoder] or
// [github.com/pritunl/mongo-go-driver/bson.Decoder]. To configure the byte slice
