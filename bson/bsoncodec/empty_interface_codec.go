...
// the configuration methods on a [github.com/pritunl/mongo-go-driver/bson.Encoder] or
// [github.com/pritunl/mongo-go-driver/bson.Decoder]. To configure the empty interface
// encode and decode behavior for a mongo.Client, use
// [github.com/pritunl/mongo-go-driver/mongo/options.ClientOptions.SetBSONOptions].
//
