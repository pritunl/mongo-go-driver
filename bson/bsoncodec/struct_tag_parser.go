...
//
// Deprecated: Use [github.com/pritunl/mongo-go-driver/bson.Encoder.UseJSONStructTags] and
// [github.com/pritunl/mongo-go-driver/bson.Decoder.UseJSONStructTags] instead.
