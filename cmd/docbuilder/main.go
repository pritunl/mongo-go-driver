...
<html lang="en">
    <head>
        ...
        <meta name="go-source" content="github.com/pritunl/mongo-go-driver https://github.com/mongodb/mongo-go-driver https://github.com/mongodb/mongo-go-driver/tree/HEAD{/dir} https://github.com/mongodb/mongo-go-driver/blob/HEAD{/dir}/{file}#L{line}">
    </head>
    <body>
        Redirecting to docs...
    </body>
