...
func TestGreater(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.helpers, "github.com/pritunl/mongo-go-driver/v2/internal/assert.Greater")
	}
}
...
func TestGreaterOrEqual(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/pritunl/mongo-go-driver/v2/internal/assert.GreaterOrEqual")
	}
}
...
func TestLess(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/pritunl/mongo-go-driver/v2/internal/assert.Less")
	}
}
...
func TestLessOrEqual(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/pritunl/mongo-go-driver/v2/internal/assert.LessOrEqual")
	}
}
...
func TestPositive(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/pritunl/mongo-go-driver/v2/internal/assert.Positive")
	}
}
...
func TestNegative(t *testing.T) {
	...
	for _, currCase := range []struct {
		...
		Contains(t, out.buf.String(), currCase.msg)
		Contains(t, out.helpers, "github.com/pritunl/mongo-go-driver/v2/internal/assert.Negative")
	}
}
